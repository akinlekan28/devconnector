...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //if profile field doesnt exist, make empty strings
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eg. Ikeja LG)"
                ...
                <div className="mb-3">
                  ...
                  }} className="btn btn-light">Add Social Network Links</span>
...
export default connect(mapStateToProps, { createUserProfile, getCurrentProfile })(withRouter(CreateProfile));
